...
# Scripts
var game_save: GameSaveService = preload("res://autoload/services/game_save/game_save_service.gd").new()
...
var user_data: UserDataService = preload("res://autoload/services/user_data_service/user_data_service.gd").new()
