...
var toaster_service: ToasterService = preload("res://autoload/services/toaster/toaster_service.gd").new()
var user_data_service: UserDataService = preload("res://autoload/services/user_data_service/user_data_service.gd").new()
