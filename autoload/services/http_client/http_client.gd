...
func _on_login_user_success(result: int, response_code: int, headers: PackedStringArray, body: PackedByteArray) -> void:
...
func _on_generate_game_save_success(result: int, response_code: int, headers: PackedStringArray, body: PackedByteArray) -> void:
	print('result:' + str(result))
	print('response_code:' + str(response_code))
	print('headers:' + str(headers))
