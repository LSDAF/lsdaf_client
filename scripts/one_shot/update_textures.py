...
def process_directory(base_dir):
    for root, _, files in os.walk(base_dir):
        for file in files:
            ...
            # Remove plural from item type (e.g., 'chestplates' -> 'chestplate')
            # Keep plural for boots and gloves, singular for others
            if item_type_in_path.lower() in ['boots', 'gloves']:
                type_name_final = item_type_in_path
            else:
                type_name_final = item_type_in_path.rstrip('s')
            
            if 'normal_' in file:
                if '_1.' in file:
                    number = "1" if is_shield else "2"
                    texture_path = f"res://asset/items/items/{base_path}/Copper/Copper_{type_name_final.capitalize()}{number}.png"
                ...
                if '_1.' in file:
                    ...
                    texture_path = f"res://asset/items/items/{base_path}/Iron/Iron_{type_name_final.capitalize()}{number}.png"
                elif '_2.' in file:
                ...
                if '_1.' in file:
                    ...
                    texture_path = f"res://asset/items/items/{base_path}/Cobalt/Cobalt_{type_name_final.capitalize()}{number}.png"
                elif '_2.' in file:
                ...
                if '_1.' in file:
                    ...
                    texture_path = f"res://asset/items/items/{base_path}/{material}/{material}_{type_name_final.capitalize()}{number}.png"
                elif '_2.' in file:
                ...
                if '_1.' in file:
                    ...
                    texture_path = f"res://asset/items/items/{base_path}/Platinum/Platinum_{type_name_final.capitalize()}{number}.png"
                elif '_2.' in file:
                ...
                if '_1.' in file:
                    ...
                    texture_path = f"res://asset/items/items/{base_path}/Angelic/Angelic_{type_name_final.capitalize()}{number}.png"
                elif '_2.' in file:
