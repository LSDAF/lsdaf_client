...
var currencies: CurrenciesService = preload("res://src/services/currencies/currencies_service.gd").new(
										Data.currencies
									)
var stage: StageService = preload("res://src/services/stage/stage_service.gd").new(
							Data.stage
						  )
var current_quest: CurrentQuestService = preload("res://src/services/current_quest/current_quest_service.gd").new(
											Data.currencies,
											 Data.current_quest,
											stage
										 )
var difficulty: DifficultyService = preload("res://src/services/difficulty/difficulty_service.gd").new(
										Data.difficulty
									)
...
var player_stats: PlayerStatsService = preload("res://src/services/player_stats/player_stats_service.gd").new()
var toaster: ToasterService = preload("res://src/services/toaster/toaster_service.gd").new()
var user_local_data: UserLocalDataService = preload("res://src/services/user_local_data/user_local_data_service.gd").new()
