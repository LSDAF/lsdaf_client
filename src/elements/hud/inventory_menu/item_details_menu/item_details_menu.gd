...
func open_for_item(item_index: int) -> void:
	...
	_item = InventoryService.get_item_at_index(item_index)
...
func _on_level_up_button_pressed() -> void:
	...
	InventoryService.level_up_item_at_index(_item_index)
...
func _on_salvage_button_pressed() -> void:
	...
	InventoryService.delete_item_at_index(_item_index)
...
func _on_equip_button_pressed() -> void:
	if _item.is_equipped:
		InventoryService.unequip_item_at_index(_item_index)
	else:
		InventoryService.equip_item_at_index(_item_index)
